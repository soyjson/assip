...
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                {!! Form::open(['url' => ['/simpan-surat-tugas-pengabmas']]) !!}
                <div class="row">
                    @foreach($data as $row)
                    <input type="hidden" name="id_lookbook" value="{{ $row->id_lookbook }}">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="judul_pengabmas" class="col-md-5 col-form-label text-md-right">{{ __('Judul pengabmas*') }}</label>
                            <div class="col-md-7">
                                <textarea id="judul_pengabmas" class="form-control{{ $errors->has('judul_pengabmas') ? ' is-invalid' : '' }}" name="judul_pengabmas" readonly="readonly">{{ $row->judul_pengabmas }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="lama_pengabmas" class="col-md-5 col-form-label text-md-right">{{ __('Lama pengabmas*') }}</label>
                            <div class="col-md-7">
                                <input id="lama_pengabmas" type="text" class="form-control{{ $errors->has('lama_pengabmas') ? ' is-invalid' : '' }}" name="lama_pengabmas" value="{{ old('lama_pengabmas') }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <table id="example" class="mb-0 table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><a title="Download Surat Tugas Pengabdian Masyarakat" href="{!! url('/'.$value->id.'/download-surat-tugas-pengabmas') !!}" target="_blank"><button class="btn btn-success">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a title="Hapus" href="{!! url('/'.$row->id.'/delete-surat-tugas-pengabmas') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
