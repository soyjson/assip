...
<center><strong>BORANG MONITORING DAN EVALUASI PENELITIAN DOSEN</strong></center><br>
<table width="100%" border="0" style="font-family: Calibri;">
    ...
    <tr>
        ...
        <td style="padding: 2px;" align="padding-top">: {{$row->judul_penelitian}}
        </td>
    </tr>
    <tr>
        <td width="30%">
...
border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="padding: 5px;">Capaian penelitian </td>
