    ...
    <div class="col-md-12">
        <div class="card mb-3">
            <div class="card-body">
                ...
                {!! Form::open(['files'=>true, 'url' => ['/simpan-tanggapan-akhir-pengabmas']]) !!}
                <div class="form-group row">
                    <label for="judul" class="col-md-2 col-form-label">{{ __('Judul Pengabmas*') }}</label>
                    <div class="col-md-10">
                        <textarea id="judul" type="text" class="form-control{{ $errors->has('judul') ? ' is-invalid' : '' }}" name="judul" readonly>{!! $value->judul_pengabmas !!}</textarea><br>
                        <table class="mb-0 table table-bordered table-hover" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    <td width="80%">Capaian pengabmas</td>
                ...
                <div class="alert alert-success">
                    ...
                    <a title="Hapus" href="{!! url('/'.$id_usulan.'/delete-tanggapan-akhir-pengabmas') !!}">
