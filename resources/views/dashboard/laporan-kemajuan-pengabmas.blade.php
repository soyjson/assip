...
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                {!! Form::open(['files'=>true, 'url' => ['/simpan-laporan-kemajuan-pengabmas']]) !!}
                @csrf
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a title="Hapus" href="{!! url('/'.$row->id.'/delete-laporan-kemajuan-pengabmas') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
