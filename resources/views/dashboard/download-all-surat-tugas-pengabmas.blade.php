    ...
    <table width="90%" border="0" align="center" style="font-family: Calibri; ">
      <tr>
        ...
        <td style="padding: 2px;">
          ...
          Pengabdian Kepada Masyarakat “{{$row->judul_pengabmas}}"
          @else
          {{$row->keperluan}}
          @endif
        </td>
      ...
      <tr>
        <td colspan="3" align="right" style="padding: 2px;">Dikeluarkan di: <?= $pengaturan->kota ?></td>
      </tr>
      <tr>
        <td colspan="3" align="right" style="padding: 2px;">Pada tanggal: {{date_format(date_create($row->tanggal),"d-m-Y")}}</td>
      </tr>
      <tr>
        <td colspan="3" align="right" style="padding-bottom: 70px; padding-top: 2px;">Ketua <?= $pengaturan->lembaga ?></td>
      </tr>
      <tr>
        <td colspan="3" align="right" style="padding: 2px;"><u><?= $pengaturan->ketua_lembaga ?></u><br>NIK <?= $pengaturan->ketua_nik ?></td>
      </tr>
    </table><br>
  </div>
</div>
