    ...
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form action="{{url('downloadakhirpenelitianExcel/xls')}}" method="GET" target="_blank">
                    ...
                    <table id="example" class="mb-0 table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">{{$value->lama_penelitian}}</td>
                                ...
                                <td align="center">
                                    <a title="Selesai Baca" href="{!! url('/'.$value->id.'/check-akhir-penelitian') !!}" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
