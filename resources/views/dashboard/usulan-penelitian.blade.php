                    ...
                    <table id="example" class="mb-0 table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a title="Lihat Penilaian" href="{!! url('/'.$value->id_usulan.'/lihat-penilaian-usulan-penelitian') !!}" target="_blank"><button class="btn btn-primary btn-sm">
    ...
    <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="mb-3 text-muted">
                    Tanda (*) artinya wajib di isi
                </p>
                {!! Form::open(['files'=>true, 'url' => ['/simpan-usulan-penelitian']]) !!}
                @csrf
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select name="nama_ketua" class="form-control select2 {{ $errors->has('nama_ketua') ? 'is-invalid' : '' }}" style="width: 100%;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="judul_penelitian" type="text" class="form-control {{ $errors->has('judul_penelitian') ? 'is-invalid' : '' }}" name="judul_penelitian" value="{{ old('judul_penelitian') }}"></textarea>
                        ...
                        <div class="form-group row">
                            <label for="jenis_penelitian" class="col-md-4 col-form-label text-md-right">{{ __('Jenis Penelitian*') }}</label>
                            <div class="col-md-8">
                                <select type="select" id="exampleCustomSelect" name="jenis_penelitian" class="form-control {{ $errors->has('jenis_penelitian') ? 'is-invalid' : '' }}">
                                    <option value="">- Pilih -</option>
                                    <option value="1">Mandiri</option>
                                    <option value="2">Hibah PT</option>
                                </select>
                                @if ($errors->has('jenis_penelitian'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jenis_penelitian') }}
                                </div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="biaya_penelitian" class="col-md-4 col-form-label text-md-right">{{ __('Biaya Penelitian') }}</label>
                            <div class="col-md-8">
                                <div id="exampleAccordion" data-children=".item">
                                    <div class="item">
                ...
                <h4 class="mb-2">Tempat Penelitian</h4>
                <p class="mb-3 text-muted">
                    Isi jika tempat penelitian sudah di tentukan
                </p>
                <div>
                    <div class="form-row">
                        <div class="col-md-6">
    ...
    <div class="tab-pane tabs-animation fade" id="tab-content-2" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                ...
                <a target="_blank" href="{{asset('/assets/file/usulan-penelitian')}}/{{$row->file}}">
                    <button class="btn btn-primary"><i class="fa fa-download"></i> Unduh Format Usulan Penelitian</button>
                </a>
                @endforeach
            </div>
        </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a title="Hapus" href="{!! url('/'.$row->id.'/delete-usulan-penelitian') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
@endforeach
@foreach($usulan as $row)
{!! Form::model($row, ['files'=>true, 'url' => ['/update-usulan-penelitian', $row->id]]) !!}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                            ...
                            <div class="col-md-8">
                                <div id="exampleAccordion" data-children=".item">
                                    <div class="item">
                                        <button type="button" aria-expanded="false" aria-controls="exampleAccordion2" data-toggle="collapse" href="#collapseExample3" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></button>
                                        <div data-parent="#exampleAccordion" id="collapseExample3" class="collapse">
                                            <select type="select" name="anggota_internal2" class="custom-select">
                                                <option value="">- Pilih Anggota -</option>
                                                @foreach($dosen as $d)
                                                <option value="{{$d->name}}" <?php if ($row->anggota_internal2 == $d->nik) { ?> <?php echo 'selected'; ?> <?php } ?>>{{$d->name}}</option>
                                                @endforeach
                                            </select>
                                            <select type="select" name="anggota_internal3" class="custom-select">
                                                <option value="">- Pilih Anggota -</option>
                                                @foreach($dosen as $d)
                                                <option value="{{$d->name}}" <?php if ($row->anggota_internal3 == $d->nik) { ?> <?php echo 'selected'; ?> <?php } ?>>{{$d->name}}</option>
                                                @endforeach
                                            </select>
                                            <select type="select" name="anggota_internal4" class="custom-select">
                                                <option value="">- Pilih Anggota -</option>
                                                @foreach($dosen as $d)
                                                <option value="{{$d->name}}" <?php if ($row->anggota_internal4 == $d->nik) { ?> <?php echo 'selected'; ?> <?php } ?>>{{$d->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="judul_penelitian" class="col-md-3 col-form-label text-md-right">{{ __('Judul Penelitian*') }}</label>
                            <div class="col-md-8">
                                <textarea id="judul_penelitian" type="text" class="form-control {{ $errors->has('judul_penelitian') ? 'is-invalid' : '' }}" name="judul_penelitian">{{ $row->judul_penelitian }}</textarea>
                                @if ($errors->has('judul_penelitian'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('judul_penelitian') }}
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="file" type="file" class="form-control {{ $errors->has('file') ? 'is-invalid' : '' }}" name="file" value="{{ $row->file }}">
                                @if ($errors->has('file'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('file') }}
                                </div>
                        ...
                        <div class="form-group row">
                            <label for="jenis_penelitian" class="col-md-3 col-form-label text-md-right">{{ __('Jenis Penelitian*') }}</label>
                            <div class="col-md-8">
                                <select type="select" id="exampleCustomSelect" name="jenis_penelitian" class="form-control {{ $errors->has('jenis_penelitian') ? 'is-invalid' : '' }}">
                                    <option value="">- Pilih -</option>
                                    <option value="1" <?php if ($row->jenis_penelitian == '1') { ?> <?php echo 'selected'; ?> <?php } ?>>Mandiri</option>
                                    <option value="2" <?php if ($row->jenis_penelitian == '2') { ?> <?php echo 'selected'; ?> <?php } ?>>Hibah PT</option>
                                </select>
                                @if ($errors->has('jenis_penelitian'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jenis_penelitian') }}
                        ...
                        <div class="form-group row">
                            <label for="biaya_penelitian" class="col-md-3 col-form-label text-md-right">{{ __('Biaya Penelitian') }}</label>
                            <div class="col-md-8">
                                <div id="exampleAccordion" data-children=".item">
                                    <div class="item">
                                        <button type="button" aria-expanded="false" aria-controls="exampleAccordion2" data-toggle="collapse" href="#collapseExample4" class="btn btn-primary btn-sm">Hibah PT</button>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="nama_institusi" class="col-md-3 col-form-label text-md-right">{{ __('Tempat Penelitian') }}</label>
                            <div class="col-md-8">
