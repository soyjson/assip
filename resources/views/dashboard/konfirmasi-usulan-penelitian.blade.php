    ...
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form action="{{url('downloadusulanpenelitianExcel/xls')}}" method="GET" target="_blank">
...
{!! Form::model($row, ['url' => ['/simpan-konfirmasi-usulan-penelitian', $row->id]]) !!}
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mediumModalLabel">Konfirmasi Usulan Penelitian</h5>
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="hidden" name="judul_penelitian" value="{{$row->judul_penelitian}}">
...
<div class="modal fade" id="myModal1{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <a title="Hapus" href="{!! url('/'.$row->id.'/batal-usulan-penelitian-diterima') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="myModal2{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <a title="Hapus" href="{!! url('/'.$row->id.'/batal-usulan-penelitian-ditolak') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
...
@foreach ($usulanditerima as $row)
{!! Form::model($row, ['url' => ['/update-dana-hibah-pt-penelitian', $row->id]]) !!}
<div class="modal fade" id="largeModal{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
