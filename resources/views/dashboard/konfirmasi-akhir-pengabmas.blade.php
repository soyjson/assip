...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#tab-content-0">
            <strong>Update Laporan Akhir</strong>
        </a>
    </li>
    <li class="nav-item">
...
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                <h3 class="mb-3">Data Laporan Akhir Baru</h3>
                <form action="{{url('downloadakhirpengabmasExcel/xls')}}" method="GET" target="_blank">
                    ...
                    <table id="example" class="mb-0 table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Jenis Luaran</th>
                        ...
                        <tbody>
                            @foreach($akhirbaru as $key => $value)
                            <tr>
                                ...
                                <td>{{$value->jenis_luaran}}</td>
                                <td align="center">{{$value->lama_pengabmas}}</td>
                                ...
                                <td align="center">
                                    <a title="Selesai Baca" href="{!! url('/'.$value->id.'/check-akhir-pengabmas') !!}" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                <h3 class="mb-3">Data Laporan Akhir di Lihat</h3>
                <div class="table-responsive">
                    <table id="example1" class="mb-0 table table-bordered table-hover">
                        ...
                        <tbody>
                            @foreach($akhirdilihat as $key => $value)
                            <tr>
                                <td align="center">{{$key+1}}</td>
                                <td width="30%">
                                    <table class="mb-0 table table-bordered table-hover table-striped">
