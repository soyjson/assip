...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a role="tab" class="nav-link" id="tab-2" data-toggle="tab" href="#tab-content-2">
            <strong>Rekap Logbook Penelitian</strong>
        </a>
    </li>
    @endif
</ul>
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                {!! Form::open(['url' => ['/simpan-lookbook-penelitian']]) !!}
    ...
    <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                <h4 class="mb-3">Histori Logbook</h4>
                    ...
                    <table id="example" class="mb-0 table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a title="Buat Surat Tugas" href="{!! url('/'.$value->id.'/buat-surat-tugas-penelitian') !!}"><button class="btn btn-primary">
    ...
    <div class="tab-pane tabs-animation fade" id="tab-content-2" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title">Rekap Logbook Penelitian</h5>
                <div class="table-responsive">
                    <table id="example1" class="mb-0 table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$value->jenis_kegiatan}}</td>
                                <td align="center">
                                    <a title="Lihat Surat Tugas" href="{!! url('/'.$value->id.'/surat-tugas-penelitian') !!}"><button class="btn btn-primary">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a title="Hapus" href="{!! url('/'.$row->id.'/delete-lookbook-penelitian') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
                </div>
            </div>
        </div>
    </div>
