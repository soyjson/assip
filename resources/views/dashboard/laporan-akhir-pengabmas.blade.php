...
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                {!! Form::open(['files'=>true, 'url' => ['/simpan-laporan-akhir-pengabmas']]) !!}
                @csrf
                <div class="form-group row">
                    <label for="judul_pengabmas" class="col-md-4 col-form-label text-md-right">{{ __('Judul Pengabmas*') }}</label>
                    <div class="col-md-6">
                        <select type="select" name="judul_pengabmas" class="select2" style="width:100%;">
                ...
                <div class="form-group row">
                    <label for="lama_pengabmas" class="col-md-4 col-form-label text-md-right">{{ __('Lama Pengabmas*') }}</label>
                    <div class="col-md-2">
                        <div class="input-group"><input type="number" class="form-control{{ $errors->has('lama_pengabmas') ? ' is-invalid' : '' }}" name="lama_pengabmas" value="{{ old('lama_pengabmas') }}" required autofocus>
                            <div class="input-group-append"><span class="input-group-text">Bulan</span></div>
                        </div>

                        @if ($errors->has('lama_pengabmas'))
                        <div class="invalid-feedback">
                            {{ $errors->first('lama_pengabmas') }}
                        </div>
                        @endif
                    </div>
                </div>
                    ...
                    <table id="example" class="mb-0 table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Lama Pengabmas</th>
                                <th class="text-center">Lama Pengabmas Riil</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">{{$value->lama_pengabmas}} Bulan</td>
                                <td align="center">{{$value->lama_pengabmas_riil}} Bulan</td>
                                ...
                                <td align="center"><a target="_blank" href="{{asset('/assets/file/laporan-akhir-pengabmas')}}/{{$value->luaran}}"><i class="fa fa-download"></i></a></td>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a title="Hapus" href="{!! url('/'.$row->id.'/delete-laporan-akhir-pengabmas') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
