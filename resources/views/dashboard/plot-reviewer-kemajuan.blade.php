        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="col-md-12">
                    ...
                    <form action="{{url('downloadreviewerkemajuanpenelitianExcel/csv')}}" method="GET" target="_blank">
                        ...
                        <table id="example1" class="mb-0 table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a title="Beri Tanggapan" href="{!! url('/'.$value->id.'/tanggapan-kemajuan-penelitian') !!}"><i class="fa fa-pen"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="col-md-12">
                    ...
                    <form action="{{url('downloadreviewerkemajuanpengabmasExcel/csv')}}" method="GET" target="_blank">
                        <button class="btn btn-primary float-right mb-3">Download</button>
                    </form>
                    @if(Auth::user()->level == 5)
                    <div class="table-responsive">
                        <table id="example4" class="mb-0 table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a target="_blank" href="{{asset('/assets/file/laporan-kemajuan-pengabmas')}}/{{$value->file}}"><i class="fa fa-download"></i></a></td>
                                    <td align="center">{{date_format(date_create($value->tanggal),"d F Y")}}</td>
                                    <td align="center">
                                        <a title="Beri Tanggapan" href="{!! url('/'.$value->id.'/tanggapan-kemajuan-pengabmas') !!}"><i class="fa fa-pen"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                ...
                {!! Form::open(['url' => ['/simpan-plot-reviewer-kemajuan-penelitian']]) !!}
    ...
    <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
        <div class="card mb-3">
            <div class="card-body">
                ...
                {!! Form::open(['url' => ['/simpan-plot-reviewer-kemajuan-pengabmas']]) !!}
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a title="Hapus" href="{!! url('/'.$row->id.'/delete-plot-reviewer-kemajuan-penelitian') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="myModal1{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <a title="Hapus" href="{!! url('/'.$row->id.'/delete-plot-reviewer-kemajuan-pengabmas') !!}" class="btn btn-danger"><i class="fa fa-trash"></i> Ok</a>
            </div>
        </div>
    </div>
</div>
